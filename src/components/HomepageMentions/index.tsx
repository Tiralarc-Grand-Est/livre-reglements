        ...
        <div className="row">
          <div className="col">
            <div className={styles.text}>
              <p>
                Ce site est un <b>projet collaboratif non officiel</b> qui vise
                à proposer une version plus lisible et plus facile à utiliser du
              ...
              <p>
                Il convient de toujours se reporter au site fédéral pour
                vérifier quelle est la dernière version du Livre des Règlements.
              </p>
            </div>
